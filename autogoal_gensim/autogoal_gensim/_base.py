...
from autogoal.kb import Word, VectorContinuous, FeatureSet
...
@nice_repr
class Word2VecEmbeddingFeatureSet(AlgorithmBase):
    """This class transform a word in embedding vector using Word2Vec of `gensim` (using `glove-twitter-25`).
...
@nice_repr
class Word2VecEmbeddingSpanishFeatureSet(AlgorithmBase):
    """This class transform a word in embedding vector using Word2Vec of `gensim` (using `Spanish 3B Word2Vec`).
...
@nice_repr
class FastTextEmbeddingSpanishSUCFeatureSet(AlgorithmBase):
    """This class transform a word in embedding vector using FastText of `gensim`.
...
@nice_repr
class FastTextEmbeddingSpanishSWBCFeatureSet(AlgorithmBase):
    """This class transform a word in embedding vector using FastText of `gensim`.
...
@nice_repr
class GloveEmbeddingSpanishSWBCFeatureSet(AlgorithmBase):
    """This class transform a word in embedding vector using Glove of `gensim`.
