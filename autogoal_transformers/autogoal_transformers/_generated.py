# AUTOGENERATED ON 2023-11-15 21:34:51.818330
...
class Abdou_ArabertBaseAlgerian(PetrainedTextClassifier):
    name = "Abdou/arabert-base-algerian"
...
class Abdou_ArabertLargeAlgerian(PetrainedTextClassifier):
    name = "Abdou/arabert-large-algerian"
    id2label = {"0": "Negative", "1": "Neutral", "2": "Positive"}
    num_classes = 3
...
class Abdou_ArabertMediumAlgerian(PetrainedTextClassifier):
    name = "Abdou/arabert-medium-algerian"
    id2label = {"0": "Negative", "1": "Neutral", "2": "Positive"}
    num_classes = 3
...
class Abdou_ArabertMiniAlgerian(PetrainedTextClassifier):
    name = "Abdou/arabert-mini-algerian"
    id2label = {"0": "Negative", "1": "Neutral", "2": "Positive"}
    num_classes = 3
...
class Claudeyang_Awesome_Fb_Model(PretrainedZeroShotClassifier):
...
class Jiva_XlmRobertaLargeItMnli(PretrainedZeroShotClassifier):
...
class Kheireddinedaouadi_Zeroaraelectra(PretrainedZeroShotClassifier):
...
class Moritzlaurer_DebertaV3BaseMnliFeverAnli(PretrainedZeroShotClassifier):
...
class Moritzlaurer_DebertaV3BaseMnli(PretrainedZeroShotClassifier):
...
class Moritzlaurer_DebertaV3XsmallMnliFeverAnliLingBinary(PretrainedZeroShotClassifier):
...
class Moritzlaurer_MdebertaV3BaseMnliXnli(PretrainedZeroShotClassifier):
...
class Moritzlaurer_XtremedistilL6H256MnliFeverAnliLingBinary(
    PretrainedZeroShotClassifier
):
...
class Ndugar_1Epochv3(PretrainedZeroShotClassifier):
...
class Ndugar_2Epochv3Mlni(PretrainedZeroShotClassifier):
...
class Ndugar_3EpochLarge(PretrainedZeroShotClassifier):
...
class Ndugar_ZsdMicrosoftV2Xxlmnli(PretrainedZeroShotClassifier):
...
class Ndugar_DebertaV2XlargeMnli(PretrainedZeroShotClassifier):
...
class Ndugar_Debertav3MnliSnliAnli(PretrainedZeroShotClassifier):
...
class Ndugar_V2XlAgainMnli(PretrainedZeroShotClassifier):
...
class Ndugar_V3LargeMnli(PretrainedZeroShotClassifier):
...
class Ndugar_V3LargeEpoch(PretrainedZeroShotClassifier):
...
class Narsil_DebertaLargeMnliZeroCls(PretrainedZeroShotClassifier):
...
class Nbailab_NbBertBaseMnli(PretrainedZeroShotClassifier):
...
class Recognai_BertBaseSpanishWwmCasedXnli(PretrainedZeroShotClassifier):
...
class Recognai_Zeroshot_Selectra_Medium(PretrainedZeroShotClassifier):
...
class Recognai_Zeroshot_Selectra_Small(PretrainedZeroShotClassifier):
...
class Sahajtomar_German_Zeroshot(PretrainedZeroShotClassifier):
